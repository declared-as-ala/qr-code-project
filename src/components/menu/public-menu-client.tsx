...
export function PublicMenuClient({
  ...
  return (
    <main className="box-border flex h-svh flex-col overflow-hidden overscroll-none bg-[linear-gradient(180deg,#f8f4ec_0%,#f4efe5_100%)] p-2 text-[#19120b] sm:p-3">
      <div className="mx-auto flex h-full min-h-0 w-full max-w-[430px] flex-col overflow-hidden rounded-[38px] border border-[#e8decd] bg-[#fffdf8] shadow-[0_22px_60px_rgba(36,28,18,0.18)]">
        <AnimatePresence mode="wait">
          ...
          {menuVisible ? (
            <motion.section
              key="book-menu"
              id="menu-content"
              className="relative flex h-full min-h-0 w-full flex-col overflow-hidden px-5 pt-5 [perspective:1200px]"
            ...
            >
              ...
              <div className="relative z-0 flex min-h-0 flex-1 flex-col">
                <div className="shrink-0 text-center">
                  ...
                  />
                  <h2 className="mt-3 font-serif text-4xl font-semibold tracking-tight leading-[1.05] text-[#1b140e]">
                ...
                <div className="mt-4 shrink-0 rounded-[22px] bg-[linear-gradient(180deg,#f8f4ec_0%,#f4efe5_100%)] px-3 py-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.65)] ring-1 ring-[#e8decd]/90">
                  <MenuCategoryChips
                ...
                <div className="safe-bottom-pad min-h-0 flex-1 overflow-y-auto overscroll-y-contain pt-4 [-ms-overflow-style:none] [scrollbar-width:none] [-webkit-overflow-scrolling:touch] [&::-webkit-scrollbar]:hidden">
                      ...
                      return (
                        ...
                        >
                          <div className="mb-3 flex items-center justify-between">
                            <h3 className="font-serif text-[30px] font-semibold leading-none tracking-tight text-[#1b140e]">
                              {category.name}
                            </h3>
